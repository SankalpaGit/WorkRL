  ...
  return (
    <div className="bg-white p-6 rounded shadow-md">
      <div className='flex justify-between items-center'>
        <h2 className="text-2xl font-bold mb-4">Donation List</h2>
        ...
        <table className="min-w-full bg-white border-collapse mt-2">
          <thead>
            <tr className="bg-gray-700">
              ...
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Donated by</th>
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Date of Donated</th>
