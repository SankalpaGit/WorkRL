        ...
        <table className="min-w-full bg-white border-collapse mt-2">
          <thead>
            <tr className="bg-gray-700">
              ...
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Username</th>
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Gmail</th>
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Status</th>
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">User Type</th>
              <th className="py-2 px-4 border border-gray-300 text-center text-gray-200">Date Joined</th>
          ...
          <tbody className="bg-red-50">
            <tr>
              ...
              <td className="py-2 px-4 border border-gray-300 text-center">San_joshi10</td>
              <td className="py-2 px-4 border border-gray-300 text-center">sankalpaTest@gmail.com</td>
              <td className="py-2 px-4 border border-gray-300 text-center">3 min ago</td>
